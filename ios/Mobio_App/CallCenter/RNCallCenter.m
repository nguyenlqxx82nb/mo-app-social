...
- (void) stringeeEndCallHandler: (NSNotification *)notif {
  ...
  NSLog(@"NOTIFICATION EVENT stringeeEndCallHandler time = %@ callId = %@ phoneNumber=%@", time, callId, phoneNumber);
  [self sendEventWithName:@"onStringeeEndCall" body:@{@"callId": callId, @"time": time, @"phoneNumber": phoneNumber}];
}
